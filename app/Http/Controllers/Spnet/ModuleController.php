...
use App\Library\SpnetHelpers;
use App\Library\ZipHelpers;
use App\Models\Spnet\Module;
...
class ModuleController extends Controller {
	...
	public function getIndex( Request $request)
	{
		...
		return view('spnet.module.index',$this->data);
	}
    ...
    function getCreate()
    {
        ...
        return view('spnet.module.create',$this->data);
    ...
    function postCreate( Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            if($request->input('creation') == 'manual')
            {
                if($where =="")                
                {
                    return Redirect::to('spnet/module/create')
        ...
        //    echo '<pre>'; print_r($columns); echo '</pre>';    exit;
            ...
            if(count($row) >= 1)
            {
                ...
                return Redirect::to('spnet/module/rebuild/'.$id->module_id);
            } else {
                return Redirect::to('spnet/module');
            }
    ...
    function getDestroy( $id = null )
    {
        $row = \DB::table('tb_module')->where('module_id', $id)
                                ->get();        
        if(count($row) <= 0){
            return Redirect::to('spnet/module')->with('messagetext','Can not find module')->with('msgstatus','error');
    ...
    function getConfig( $id )
    {
		...
		return view('spnet.module.config',$this->data);
    ...
    function postSaveconfig( Request $request) 
    {
        ...
        if ($validator->passes()) {
            ...
            return Redirect::to('spnet/module/config/'.$request->input('module_name'))
    ...
    function getSql(Request $request , $id )
    {
		...
		$this->data['module_name'] 		= $row->module_name;    
		$this->data['module'] 			= 'module';
		return view('spnet.module.sql',$this->data);
    ...
    function postSavesql( Request $request ,$id )
    {
        ...
        try {   
            ...
            // Do something when query fails. 
            $error ='Error : '.$select .' '.$where.' '.$group ;
            return Redirect::to('spnet/module/sql/'.$request->input('module_name'))
       ...
       \DB::table('tb_module')
        ...
        return Redirect::to('spnet/module/sql/'.$row->module_name)
    ...
    function getTable( $id )
    {
		...
		$this->data['module'] = 'module';
		$this->data['module_name'] = $row->module_name;
		return view('spnet.module.table',$this->data);
    ...
    function getForm( $id )
    {
		...
		$this->data['module'] = 'module';
		$this->data['module_name'] = $row->module_name;
		return view('spnet.module.form',$this->data);
    ...
    public function postSaveform( Request $request)
    {
       ...
       // echo '<pre>'; print_r($new_config); echo '</pre>';    exit;
        ...
        return Redirect::to('spnet/module/form/'.$row->module_name)
    ...
    public function getEditform(Request $request, $id )
    {
        ...
        $this->data['module'] = 'module';
        $this->data['module_name'] = $row->module_name;
        return view('spnet.module.field',$this->data);
    } 
   ...
   function postSaveformfield( Request $request)
    ...
    public function postSavetable( Request $request)
    {
       ...
       // echo '<pre>'; print_r($new_config); echo '</pre>';    exit;
        ...
        return Redirect::to('spnet/module/table/'.$row->module_name)
   ...
   function getPermission( $id )
    {
            ...
            */   
            ...
            return view('spnet.module.permission',$this->data);
    ...
    public function postSavepermission( Request $request)
    {
        ...
        */         
        ...
        return Redirect::to('spnet/module/permission/'.$row->module_name)
    ...
    function getBuild( $id )
    {
        ...
        return view('spnet.module.build',$this->data);
    ...
    function getFormdesign( Request $request , $id)
    {
        ...
        $this->data['module_name'] = $row->module_name;
        return view('spnet.module.formdesign',$this->data);
    }   
    ...
    //    echo '<pre>'; print_r($f); echo '</pre>';    exit;
     ...
     //  echo '<pre>'; print_r($new_config); echo '</pre>';    exit;
      \DB::table('tb_module')
        ...
        return Redirect::to('spnet/module/formdesign/'.$row->module_name)
    ...
    function getSub( Request $request, $id ='')
    {
		...
		return view('spnet.module.sub',$this->data);
    ...
    function postSavesub( Request $request)
    {
        ...
        if ($validator->passes()) {                
          ...
          //  echo '<pre>'; print_r($new_config); echo '</pre>'; exit;
            ...
            return Redirect::to('spnet/module/sub/'.$row->module_name)
            ->with('messagetext','Master Has beed added Successful.')->with('msgstatus','success');  

        }    else {

            return Redirect::to('spnet/module/sub/'.$request->get('module_name'))
    ...
    function getConn( Request $request , $id )
    {
        ...
        return view('spnet.module.connection',$this->data);
    }   
   ...
   function configGrid ( $field , $alias , $type, $sort ) {
    ...
    function postDobuild( Request $request ,$id )
    {
        ...
        //return redirect('')
        $url = 'spnet/module/rebuild/'.$id."?rebuild=y&c={$c}&m={$m}&g={$g}&f={$f}&v={$v}";
    ...
    public function getRebuild(Request $request, $id = 0)
    {
            ...
            if($row->module_type =='generic')
            {
                ...
                $template = base_path().'/resources/views/spnet/module/template/blank/';
            ...
            {
                $template   = base_path().'/resources/views/spnet/module/template/report/';
                $controller = file_get_contents( $template.'controller.tpl' );
                $grid       = file_get_contents(  $template.'grid.tpl' );
                $model       = file_get_contents(  $template.'model.tpl' );  
            ...
            if($row->module_type =='addon')
            {
                ...
                $template = base_path().'/resources/views/spnet/module/template/native/';
                $controller = file_get_contents(  $template.'controller.tpl' );
                $grid = file_get_contents(  $template.'grid.tpl' );               
                $view = file_get_contents(  $template.'view.tpl' );
                $form = file_get_contents(  $template.'form.tpl' );
            ...
            return Redirect::to('spnet/module')->with('messagetext','Code Script has been replaced successfull')->with('msgstatus','success');
    ...
    function postPackage( Request $request) 
    {
        ...
        return view('spnet.module.package',$this->data);
  ...
  function postInstall( Request $request ,$id =0)
  {
    ...
    if ($validator->passes()) {
      ...
      $data = \SpnetHelpers::cf_unpackage($path);
      ...
      self::createRouters();
          ...
          return Redirect::to('spnet/module')->with('messagetext','Module Installed' . $msg)->with('msgstatus','success');
    }  else  {
         return Redirect::to('spnet/module')->with('messagetext','Please select file to upload !')->with('msgstatus','error');
    } 
