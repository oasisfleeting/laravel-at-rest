(function (a) {
	var b = function (b) {
		...
		if (b.cursor_position != a(b).find(".cssConsoleDisplay span").length) {
			a(b).find(".cssConsoleCursor").css({visibility: "hidden"});
			...
			a(b).find(".cssConsoleCursor").css({visibility: "visible"});
			b.cursor = window.setInterval(function () {
	...
	var c = {
		init      : function (c) {
			...
			return this.each(function () {
				...
				e.append('<input class="cssConsoleInput" type="' + d.type + '" />');
				if (d.inputId) {
				...
				e.find(".cssConsoleInput").on("blur", function () {
					...
					if (c.cursor_position != e.find(".cssConsoleDisplay span").length) {
						...
						e.find(".cssConsoleCursor").css({visibility: "hidden"});
					}
				});
			...
			return this.each(function () {
				...
				if (d.find(".cssConsoleInput").is(":focus")) {
					...
					clearInterval(c.cursor);
					d.find(".cssConsoleCursor").css({visibility: "hidden"});
				}
