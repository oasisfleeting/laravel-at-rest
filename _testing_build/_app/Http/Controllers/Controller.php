...
abstract class Controller extends BaseController
{
	...
	public function __construct()
	{
		...
		if (\Auth::check() == true)
		{
			...
			if (!\Session::get('gid'))
			{
				...
				\Session::put('themes', 'spnet-light-blue');
			}
		}
	...
	public function getSearch()
	{
		...
		return view('spnet.module.utility.search', $this->data);
	...
	function detailview($model, $detail, $id)
	{
		...
		$params            = array('params' => " And `" . $detail['key'] . "` ='" . $id . "'", 'global' => (isset($this->access['is_global']) ? $this->access['is_global'] : 0));
