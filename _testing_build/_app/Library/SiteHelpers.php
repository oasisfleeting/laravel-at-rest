...
class SiteHelpers
{
	...
	/**
	 * @param            $in
	 * @param bool|false $to_num
	 * @param bool|false $pad_up
	 * @param null       $passKey
	 *
	...
	public static function toMasterDetail($info)
	{
		...
		if (count($info) >= 1)
		{
			...
			$tpl = array();
			require_once('../resources/views/spnet/module/template/native/masterdetailform.php');
	...
	public static function BBCode2Html($text)
	{
		...
		$emotion = URL::to('spnet/js/plugins/markitup/images/emoticons/');
