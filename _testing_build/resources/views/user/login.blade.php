    ...
    <div class="sbox ">
        ...
        <div class="sbox-content">
            <div class="text-center  animated fadeInDown delayp1">
                <img src="{{ asset('spnet/images/logo-spnet.png')}}" width="70" height="70" />
            </div>
                    ...
                    <form method="post" action="{{ url('user/signin')}}" class="form-vertical">
                        ...
                        <div class="form-group  has-feedback text-center  animated fadeInLeft delayp1" style=" margin-bottom:20px;">
                            ...
                            <button type="submit" class="btn btn-info btn-sm btn-block">
                                <i class="fa fa-sign-in"></i> {{ Lang::get('core.signin') }}</button>
                            ...
                            <div class="form-group has-feedback text-center">
                                ...
                                <div style="padding:15px 0;">
                                    @if($socialize['facebook']['client_id'] !='')
                                        <a href="{{ URL::to('user/socialize/facebook')}}" class="btn btn-primary"><i class="icon-facebook"></i> Facebook
                                        </a>
                                    @endif
                                    @if($socialize['google']['client_id'] !='')
                                        <a href="{{ URL::to('user/socialize/google')}}" class="btn btn-danger"><i class="icon-google"></i> Google
                                        </a>
                                    @endif
                                    @if($socialize['twitter']['client_id'] !='')
                                        <a href="{{ URL::to('user/socialize/twitter')}}" class="btn btn-info"><i class="icon-twitter"></i> Twitter
                                        </a>
                                    @endif
                                </div>
                            </div>
