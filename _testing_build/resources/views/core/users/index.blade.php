...
<div class="sbox-tools" >
	...
	<div class="sbox-content"> 	
	    <div class="toolbar-line ">
			...
			@endif	
			<a href="{{ URL::to( 'core/users/search') }}" class="btn btn-sm btn-white" onclick="SpnetModal(this.href,'Advance Search'); return false;" ><i class="text-danger fa fa-search"></i> Search</a>
		 
		</div> 		

	
	
	 {!! Form::open(array('url'=>'core/users/delete/', 'class'=>'form-horizontal' ,'id' =>'SpnetTable' )) !!}
...
$(document).ready(function(){
	...
	$('.do-quick-search').click(function(){
		$('#SpnetTable').attr('action','{{ URL::to("core/users/multisearch")}}');
		$('#SpnetTable').submit();
	});
