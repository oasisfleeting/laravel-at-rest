    ...
    <div class=" container">
        <div class="col-sm-6 col-xs-6">
            <div class="page-title">
                <h3> FAQ
                    <small>Your Questions Answered.</small>
                </h3>
            </div>
        </div>
        <div class="col-sm-6 col-xs-6 ">
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a href="#1" data-parent="#accordion" data-toggle="collapse" class="collapsed">
                                What is Spnet Builder ? </a>
                        </h4>
                    </div>
                    <div class="panel-collapse collapse" id="1">
                        <div class="panel-body">
                            <p>Lorem ipsum dolor sit
                                <span style="font-weight: bold;"><span style="color: rgb(255, 0, 0);">amet</span></span>, consectetur adipiscing elit. Morbi id neque quam. Aliquam sollicitudin venenatis ipsum ac feugiat. Vestibulum ullamcorper sodales nisi nec condimentum. Mauris convallis mauris at pellentesque volutpat. Lorem ipsum dolor sit amet, consectetur
                                <br></p>
                            ...
                            <p>adipiscing elit. Morbi id neque quam. Aliquam sollicitudin venenatis ipsum ac feugiat. Vestibulum ullamcorper sodales nisi nec condimentum. Mauris convallis mauris at pellentesque volutpat. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi id neque quam. Aliquam
                                sollicitudin venenatis ipsum ac feugiat. Vestibulum ullamcorper sodales nisi nec condimentum. Mauris convallis mauris at pellentesque volutpat. </p>
                        </div>
                    </div>
                </div>
                <div class="panel panel-default faq-panel">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a href="#2" data-parent="#accordion" data-toggle="collapse" class="collapsed">
                                What are the applications type created by Spnet Builder ? </a>
                        </h4>
                    </div>
                    <div class="panel-collapse collapse" id="2" style="height: 0px;">
                        <div class="panel-body">
                            ...
                            sollicitudin venenatis ipsum ac feugiat. Vestibulum ullamcorper sodales nisi nec condimentum. Mauris convallis mauris at pellentesque volutpat.
                        </div>
                    </div>
                </div>
                <div class="panel panel-default faq-panel">
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a href="#6" data-parent="#accordion" data-toggle="collapse" class="collapsed">
                                What are the requirements to run Spnet Builder ? </a>
                        </h4>
                    </div>
