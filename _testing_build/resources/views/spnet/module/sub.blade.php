...
@section('content')
  ...
  <div class="page-content row">
	...
	@include('spnet.module.tab',array('active'=>'sub'))
...
<div class="sbox">
  ...
  @if(count($subs) < 1)
    {!! Form::open(array('url'=>'spnet/module/savesub/'.$module_name, 'class'=>'form-horizontal  ')) !!}
 ...
 @endif
    ...
    <tbody class="no-border-x no-border-y"> 
      ...
      <tr>
        ...
        onclick="SpnetConfirmDelete('{{ URL::to('spnet/module/removesub?id='.$row->module_id.'&mod='.$rows['module']) }}');"
...
$(document).ready(function(){   
    $("#table").jCombo("{{ url('spnet/module/combotable') }}",
    { }); 
    $("#key").jCombo("{{ url('spnet/module/combotablefield') }}?table=",
    { parent  :  "#table"}); 
});
</script> 
