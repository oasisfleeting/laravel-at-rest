...
class TablesController extends Controller
{
    ...
    public function getIndex()
	{
		...
		return view('spnet.tables.index',$this->data);
	}
    ...
    public function getTableconfig( $table = null )
    {
        ...
        $this->data['action'] = ($table ==null ? 'spnet/tables/tables/'.$table : 'spnet/tables/tableinfo/'.$table ) ;
        return view('spnet.tables.config',$this->data);
    }

	/**
     * @param \Illuminate\Http\Request $request
     * @param null                     $currtable
     *
     * @return mixed
     */
    ...
    public function postTableremove(Request $request)
    {
        ...
        if(!is_null($request->input('id')) && count($request->input('id')) >=1 )
        {
            ...
            return Redirect::to('spnet/tables')->with('messagetext', 'Table(s) has been deleted')->with('msgstatus','success');
        } 
        return Redirect::to('spnet/tables')->with('messagetext','error','No Table(s) deleted !')->with('msgstatus','error');
    ...
    public function getTablefieldedit( $table )
    {
        ...
        return view('spnet.tables.field',$this->data);
    }
    ...
    public function getMysqleditor()
    {
        ...
        return view('spnet.tables.editor');
    }
