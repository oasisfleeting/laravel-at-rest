...
<div class="block-content">
	@include('spnet.config.tab')
<div class="tab-content m-t">
  <div class="tab-pane active use-padding" id="info">	
  <div class="sbox  "> 
  <div class="sbox-title"></div>
  <div class="sbox-content"> 
		 {!! Form::open(array('url'=>'spnet/config/save/', 'class'=>'form-horizontal row', 'files' => true)) !!}
		   ...
		   <div class="form-group">
			...
			<div class="col-md-8">
				...
				<div style="padding:5px; border:solid 1px #ddd; background:#f5f5f5; width:auto;">
				 	@if(file_exists(public_path().'/spnet/images/'.CNF_LOGO) && CNF_LOGO !='')
				 	<img src="{{ asset('spnet/images/'.CNF_LOGO)}}" alt="{{ CNF_APPNAME }}" />
				 	@else
					<img src="{{ asset('spnet/images/logo.png')}}" alt="{{ CNF_APPNAME }}" />
					@endif	
				</div>				
			 </div> 
		  </div>  		  
