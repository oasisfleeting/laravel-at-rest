...
@section('content')
  <div class="page-content row">
	...
	@include('spnet.module.tab',array('active'=>'table'))

@if(Session::has('message'))
       {{ Session::get('message') }}
@endif

 {!! Form::open(array('url'=>'spnet/module/savetable/'.$module_name, 'class'=>'form-horizontal')) !!}
<div class="sbox">
			...
			<?php usort($tables, "SiteHelpers::_sort"); ?>
			  ...
			  <tr >
				...
				<span class=" xlick " title="Lookup Display" 
					onclick="SpnetModal('{{ URL::to('spnet/module/conn/'.$row->module_id.'?field='.$rows['field'].'&alias='.$rows['alias']) }}' ,' Connect Field : {{ $rows['field']}} ' )"
					>
