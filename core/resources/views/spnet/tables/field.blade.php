{!! Form::open(array('url'=>'spnet/tables/tablefieldsave/'.$table, 'class'=>'form-horizontal','id'=>'columnTable' )) !!}
...
function showResponse(data)  {		
	...
	{
		url = "{{ URL::TO('spnet/tables/tableconfig/'.$table) }}";
		$.get( url , function( data ) {
			$('#spnet-modal').modal('hide');
