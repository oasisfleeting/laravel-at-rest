...
<html lang="en">
  <head>
    ...
    <link href="{{ asset('spnet/themes/elliot/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{ asset('spnet/themes/elliot/css/style.css')}}" rel="stylesheet">
    <link href="{{ asset('spnet/themes/elliot/css/font-icons.css')}}" rel="stylesheet">
    <link href="{{ asset('spnet/themes/elliot/css/animate.css')}}" rel="stylesheet">
    <link href="{{ asset('spnet/themes/elliot/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet">
    ...
    <script src="{{ asset('spnet/themes/elliot/js/bootstrap.min.js')}}"></script>
    <script src="{{ asset('spnet/themes/elliot/js/jquery.mixitup.min.js')}}"></script>
    <script type="text/javascript" src="{{ asset('spnet/js/plugins/parsley.js') }}"></script>
    <script type="text/javascript" src="{{ asset('spnet/themes/elliot/js/fancybox/source/jquery.fancybox.js') }}"></script>
    ...
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="{{ url()}}">
          <img src="{{ asset('spnet/themes/elliot/images/logo.png')}}">
        </a>
      </div>
