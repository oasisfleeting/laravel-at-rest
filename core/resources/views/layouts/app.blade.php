    ...
    <div class="theme-config-box">
        ...
        <div class="skin-setttings">
            ...
            <div class="setings-item">
                    <ul>
	                    <li><a href="{{ url('home/skin/spnet') }}"> Default Skin  <span class="pull-right default-skin"> </span></a></li>
	                    <li><a href="{{ url('home/skin/spnet-dark-blue') }}"> Dark Blue Skin <span class="pull-right dark-blue-skin"> </span> </a></li>
	                    <li><a href="{{ url('home/skin/spnet-light-blue') }}"> Light Blue Skin <span class="pull-right light-blue-skin"> </span> </a></li>
