<div class="row  ">
		...
		<li class="user dropdown"><a class="dropdown-toggle" href="javascript:void(0)"  data-toggle="dropdown"><i class="fa fa-desktop"></i> <span>{{ Lang::get('core.m_controlpanel') }}</span><i class="caret"></i></a>
		  <ul class="dropdown-menu dropdown-menu-right icons-right">
		  	...
		  	<li><a href="{{ URL::to('spnet/config')}}"><i class="fa  fa-wrench"></i> {{ Lang::get('core.m_setting') }}</a></li>
			...
			<li class="divider"></li>
			<li><a href="{{ URL::to('spnet/module')}}"><i class="fa fa-cogs"></i> {{ Lang::get('core.m_codebuilder') }}</a></li>
			<li><a href="{{ URL::to('spnet/tables')}}"><i class="icon-database"></i> Database Tables </a></li>
			<li><a href="{{ URL::to('spnet/menu')}}"><i class="fa fa-sitemap"></i> {{ Lang::get('core.m_menu') }}</a></li>
			<li class="divider"></li>
