...
<script type="text/javascript" src="{{ asset('spnet/js/plugins/chartjs/Chart.min.js') }}"></script>
...
<section>
	<div class="row m-l-none m-r-none m-t  white-bg shortcut " >
		<div class="col-sm-6 col-md-3 b-r  p-sm ">
			...
			<a href="{{ URL::to('spnet/module') }}" class="clear">
		...
		<div class="col-sm-6 col-md-3 b-r  p-sm">
			...
			<a href="{{ URL::to('spnet/config') }}" class="clear">
		...
		<div class="col-sm-6 col-md-3 b-r  p-sm">
			...
			<a href="{{ URL::to('spnet/menu') }}" class="clear">
